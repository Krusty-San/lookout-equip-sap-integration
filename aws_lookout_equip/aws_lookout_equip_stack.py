...
#     PythonFunction
# )
class AwsLookoutEquipStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        #2.Layers
        layers = LambdaLayers(self,'l4elambdalayers')
        
        #3.Roles
        l4erole = rolesConstruct(self, 'l4erole')

        #4.DDB
        ddbConstruct(self, 'pmconfigddb',props={
             'config': appConfig,
             'ddbrole': l4erole._lambdarole
         } )

        #5.S3 Bucket
        #pocbucket = s3.Bucket(self,'l4ebucket',
       ...
       # customResourceConstruct(self, 'l4efolders', props={
    #        'config': appConfig,
    #        'role': l4erole._lambdarole,
    ...
    #    })
        ...
        LambdaConstruct(self, 'poclambda', props={
            ...
            'subnet': lamdbasubnet,
            'config': appConfig,
            'lambdarole': l4erole._lambdarole
            })
